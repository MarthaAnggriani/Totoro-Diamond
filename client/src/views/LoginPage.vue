...
export default {
    ...
    methods: {
        ...mapActions(useDiamondStore, ['handleLogin', 'googleLogin', 'handleRegister']),
...
<template>
    ...
    <div class="py-6">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            <!-- <div class="hidden lg:block lg:w-1/2 bg-cover" style="background-image:url('../images/layla-aspirants.jpg')">
            </div> -->

            <!-- Register -->
            <div class="w-full p-8 lg:w-1/2">
                <h2 class="text-2xl font-semibold text-gray-700 text-center">Register</h2>
                <p class="text-xl text-gray-600 text-center">Hello there!</p>
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <a @click.prevent="$router.push(`/login`)" href="#" class=" text-xs text-gray-500 uppercase">Already
                        have account?</a>
                    <span class="border-b w-1/5 md:w-1/4"></span>
                </div>
            </div>
            ...
            <!-- Login -->
            <div class="w-full p-8 lg:w-1/2">
                <h2 class="text-2xl font-semibold text-gray-700 text-center">Sign In</h2>
                ...
                <div class="mt-4 flex items-center justify-between">
                    <span class="border-b w-1/5 md:w-1/4"></span>
                    <a @click.prevent="$router.push(`/login`)" href="#" class=" text-xs text-gray-500 uppercase">or sign
                        up</a>
                    <span class="border-b w-1/5 md:w-1/4"></span>
                </div>
            </div>
